...
ac_dec_list mips1_parms::mips1_isa::dec_list[mips1_parms::AC_DEC_LIST_NUMBER] = {
  ...
  {"func", 6, 0, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[44])},
  {"func", 6, 2, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[46])},
  {"func", 6, 3, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[48])},
  {"func", 6, 4, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[50])},
  {"func", 6, 6, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[52])},
  {"func", 6, 7, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[54])},
  {"func", 6, 24, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[56])},
  {"func", 6, 25, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[58])},
  {"func", 6, 26, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[60])},
  {"func", 6, 27, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[62])},
  {"func", 6, 16, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[64])},
  {"func", 6, 17, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[66])},
  {"func", 6, 18, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[68])},
  {"func", 6, 19, NULL},
  {"op", 1, 2, NULL},
  {"op", 1, 3, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[72])},
  {"func", 6, 8, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[74])},
  {"func", 6, 9, NULL},
  {"op", 1, 4, NULL},
  {"op", 1, 5, NULL},
  {"op", 1, 6, &(mips1_parms::mips1_isa::dec_list[78])},
  {"rt", 3, 0, NULL},
  {"op", 1, 7, &(mips1_parms::mips1_isa::dec_list[80])},
  {"rt", 3, 0, NULL},
  {"op", 1, 1, &(mips1_parms::mips1_isa::dec_list[82])},
  {"rt", 3, 0, NULL},
  {"op", 1, 1, &(mips1_parms::mips1_isa::dec_list[84])},
  {"rt", 3, 1, NULL},
  {"op", 1, 1, &(mips1_parms::mips1_isa::dec_list[86])},
  {"rt", 3, 16, NULL},
  {"op", 1, 1, &(mips1_parms::mips1_isa::dec_list[88])},
  {"rt", 3, 17, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[90])},
  {"func", 6, 12, NULL},
  {"op", 1, 0, &(mips1_parms::mips1_isa::dec_list[92])},
  {"func", 6, 13, NULL}
};
...
ac_dec_instr mips1_parms::mips1_isa::instructions[mips1_parms::AC_DEC_INSTR_NUMBER] = {
  ...
  {"sll", 4, "sll", "sll %reg, %reg, %imm", "Type_R", 31, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[41]), 0, &(mips1_parms::mips1_isa::instructions[31])},
  {"srl", 4, "srl", "srl %reg, %reg, %imm", "Type_R", 32, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[43]), 0, &(mips1_parms::mips1_isa::instructions[32])},
  {"sra", 4, "sra", "sra %reg, %reg, %imm", "Type_R", 33, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[45]), 0, &(mips1_parms::mips1_isa::instructions[33])},
  {"sllv", 4, "sllv", "sllv %reg, %reg, %reg", "Type_R", 34, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[47]), 0, &(mips1_parms::mips1_isa::instructions[34])},
  {"srlv", 4, "srlv", "srlv %reg, %reg, %reg", "Type_R", 35, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[49]), 0, &(mips1_parms::mips1_isa::instructions[35])},
  {"srav", 4, "srav", "srav %reg, %reg, %reg", "Type_R", 36, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[51]), 0, &(mips1_parms::mips1_isa::instructions[36])},
  {"mult", 4, "mult", "mult %reg, %reg", "Type_R", 37, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[53]), 0, &(mips1_parms::mips1_isa::instructions[37])},
  {"multu", 4, "multu", "multu %reg, %reg", "Type_R", 38, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[55]), 0, &(mips1_parms::mips1_isa::instructions[38])},
  {"div", 4, "div", "div %reg, %reg", "Type_R", 39, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[57]), 0, &(mips1_parms::mips1_isa::instructions[39])},
  {"divu", 4, "divu", "divu %reg, %reg", "Type_R", 40, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[59]), 0, &(mips1_parms::mips1_isa::instructions[40])},
  {"mfhi", 4, "mfhi", "mfhi %reg", "Type_R", 41, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[61]), 0, &(mips1_parms::mips1_isa::instructions[41])},
  {"mthi", 4, "mthi", "mthi %reg", "Type_R", 42, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[63]), 0, &(mips1_parms::mips1_isa::instructions[42])},
  {"mflo", 4, "mflo", "mflo %reg", "Type_R", 43, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[65]), 0, &(mips1_parms::mips1_isa::instructions[43])},
  {"mtlo", 4, "mtlo", "mtlo %reg", "Type_R", 44, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[67]), 0, &(mips1_parms::mips1_isa::instructions[44])},
  {"j", 4, "j", "j %exp(align)", "Type_J", 45, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[69]), 0, &(mips1_parms::mips1_isa::instructions[45])},
  {"jal", 4, "jal", "jal %exp(align)", "Type_J", 46, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[70]), 0, &(mips1_parms::mips1_isa::instructions[46])},
  {"jr", 4, "jr", "jr %reg", "Type_R", 47, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[71]), 0, &(mips1_parms::mips1_isa::instructions[47])},
  {"jalr", 4, "jalr", "jalr %reg, %reg", "Type_R", 48, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[73]), 0, &(mips1_parms::mips1_isa::instructions[48])},
  {"beq", 4, "beq", "beq %reg, %reg, %exp(pcrel)", "Type_I", 49, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[75]), 0, &(mips1_parms::mips1_isa::instructions[49])},
  {"bne", 4, "bgtu", "bgtu %reg, $0, %exp(pcrel)", "Type_I", 50, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[76]), 0, &(mips1_parms::mips1_isa::instructions[50])},
  {"blez", 4, "blez", "blez %reg, %exp(pcrel)", "Type_I", 51, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[77]), 0, &(mips1_parms::mips1_isa::instructions[51])},
  {"bgtz", 4, "bgtz", "bgtz %reg, %exp(pcrel)", "Type_I", 52, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[79]), 0, &(mips1_parms::mips1_isa::instructions[52])},
  {"bltz", 4, "bltz", "bltz %reg, %exp(pcrel)", "Type_I", 53, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[81]), 0, &(mips1_parms::mips1_isa::instructions[53])},
  {"bgez", 4, "bgez", "bgez %reg, %exp(pcrel)", "Type_I", 54, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[83]), 0, &(mips1_parms::mips1_isa::instructions[54])},
  {"bltzal", 4, "bltzal", "bltzal %reg, %exp(pcrel)", "Type_I", 55, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[85]), 0, &(mips1_parms::mips1_isa::instructions[55])},
  {"bgezal", 4, "bgezal", "bgezal %reg, %exp(pcrel)", "Type_I", 56, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[87]), 0, &(mips1_parms::mips1_isa::instructions[56])},
  {"sys_call", 4, "syscall", "syscall", "Type_R", 57, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[89]), 0, &(mips1_parms::mips1_isa::instructions[57])},
  {"instr_break", 4, "break", "break", "Type_R", 58, 1, 1, 1, &(mips1_parms::mips1_isa::dec_list[91]), 0, NULL}
};
